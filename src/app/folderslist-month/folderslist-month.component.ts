...
@Component({
  selector: 'app-folderslist-month',
  templateUrl: './folderslist-month.component.html',
  styleUrls: ['./folderslist-month.component.scss'],
})
export class FolderslistMonthComponent implements OnInit {

  public lastWeekFolders: Folder[];
  public lastMonthFolders: Folder[];
  public totalweekpage:number;
  public totalMonthpage:number;
  public totalMonthpage2:number [];
  ...
  ngOnInit(): void {
    this.folderService.getFAvoritFoldersIds().subscribe(ids => {
      ...
      this.getAllFolders();
      this.getAllFoldersMonth(this.Index);
      this.getAllFoldersOLD();
      this.isLoading = true;
  ...
  getAllFoldersMonth(i:number){
    this.folderService.getAllFoldersMonth(i,this.pageSizeMonth)
      .subscribe(folders => {
        ...
        this.totalMonthpage2=new Array<number>(this.totalMonthpage);
